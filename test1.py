...
cred = credentials.Certificate("/home/pi/test/ble_test/ai-health-telemetry-system-firebase-adminsdk-ls5j6-e1792de1e8.json")
...
def  telemetry(t,m,g,A,h,R,HR):
    ...
    doc_ref = db.collection(u'AI HEALTHCARE TELEMTERY ').document(u'data')
    doc_ref.set(data_base)
